...
from .edit_plan_check import check_edit_plan
...
def evaluate(code: str, tools: Dict[str, Callable], state=None, chat_mode=False):
    ...
    # Aurora-style plan check: verify the structured edit plan is complete
    # before executing any tool, surfacing underspecification up front.
    plan_report = check_edit_plan(expression, tools)
    if not plan_report.is_complete:
        print("Edit plan underspecified before execution:")
